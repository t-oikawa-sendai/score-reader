...
| 現行公開方針 | 現在公開中のテスト素材は権利確認中である。判断完了までの暫定措置として公開継続する |
| 禁止事項 | 著作権保護された楽譜 PDF・MusicXML・画像をリポジトリに含めない |
| 確定事項 | 最終判断責任者: Takashi Oikawa。判断期限: 2026-09-06。暫定措置: 権利確認中・公開可否未確定であることを明示して公開継続 |
...
| 現行テスト素材の公開 | 現在公開中のテスト素材は権利確認中であり、公開可否は法的に未確定である。最終判断責任者は Takashi Oikawa、判断期限は 2026-09-06 である。判断完了までの暫定措置は、その旨を明示した上での公開継続である |

未解決事項は TBD-005 に限定する。最終判断責任者、判断期限、暫定措置、現時点の公開継続方針は未確定ではない。
...
| TBD-005 | テスト素材の未解決権利事項。MusicXML エンコーディングの個別利用条件、世界向け再配布可否の法的確定、準拠法域。最終判断責任者（Takashi Oikawa）、判断期限（2026-09-06）、暫定措置（権利確認中である旨を明示して公開継続）は確定済みであり、本 TBD の対象外。 | Takashi Oikawa | 未定 | Open |
...
3. **テスト素材の権利確認**: `prototype/tests/` 追加前に、楽曲の権利、MusicXML エンコーディングの権利、加工・再配布条件を分けて確認すること（§5.4、TBD-005 参照）。パブリックドメイン楽譜であることだけで公開可能としない。現行公開中素材は権利確認中の暫定公開継続である。最終判断責任者は Takashi Oikawa、判断期限は 2026-09-06。未解決はエンコーディング個別利用条件、再配布可否の法的確定、準拠法域に限定する。
